import argparse
import sys
from utils import env_utils, logging, container, subprocess_utils
...
def handle_exec_command(args):
    ...
    completed = subprocess_utils.run_subprocess(['devcontainer', 'exec', '--workspace-folder', env_utils.PROJECT_DIR] + args.exec_args, 
